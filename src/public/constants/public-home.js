...
export const HOW_IT_WORKS_SUBTITLE_STEP_1 = 'VOCÊ ESCOLHE UM PLANO';

export const HOW_IT_WORKS_SUBTITLE_STEP_2 = 'VOCÊ ESCOLHE SEU JOGO';

export const HOW_IT_WORKS_SUBTITLE_STEP_3 = 'JOGUE O QUANTO QUISER!';

export const HOW_IT_WORKS_DESCRIPTION_STEP_1 = 'Temos 4 planos que se adequam ao seu estilo de jogo';
